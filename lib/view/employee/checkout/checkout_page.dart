...
class _CheckOutPageState extends State<CheckOutPage> {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  // _body(),
                  StreamBuilder(
                    stream: checkoutBloc.getCheckInFormStream,
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              context,
                              () async {
                                await checkoutBloc.getCheckinForm();
                              },
                              borderRadius: BorderRadius.circular(15.r),
                                ...
                                children: [
                                    ...
                                    children: [
                                      Expanded(
                                        child: CheckInDropDown(
                                          textStream: checkoutBloc.employeeFilterStream,
                                          heading: 'Employee',
                                      ...
                                      Expanded(
                                        child: CheckInDropDown(
                                          textStream: checkoutBloc.projectFilterStream,
                                          heading: 'Project',
                                          hint: 'Select Project',
                                          // items:leaveFormModel != null ? ['', 'Qtn2016', 'Qtn2017', 'Qtn2018'] : ['', 'Qtn2016', 'Qtn2017', 'Qtn2018'],
                                          items: (checkInFormModel != null &&
                                    ...
                                    children: [
                                      Expanded(
                                        child: CheckInField(
                                          ...
                                          textStream: checkoutBloc.checkOutFromDateFilterStream,
                                          ...
                                          onTap: () async {
                                            ...
                                            if (date != null) {
                                              checkoutBloc.checkOutFromDateFilterStream.add(date);
                                            }
                                          },
                                        ),
                                      ),
                                      ...
                                      Expanded(
                                        child: CheckInField(
                                          ...
                                          textStream: checkoutBloc.checkOutToDateFilterStream,
                                          // onChanged: bloc.checkinTimeStream.add,
                                          onTap: () async {
                                            final date = await _selectDate(context);

                                            if (date != null) {
                                              checkoutBloc.checkOutToDateFilterStream.add(date);
                                            }
                                          },
                                        ),
                                      ),
                                      ...
                                      Expanded(
                                        child: CheckInDropDown(
                                          textStream: checkoutBloc.checkOutStatusFilterStream,
                                          heading: 'Status',
                                          hint: 'Select Status',
                                          // items:leaveFormModel != null ? ['', 'Qtn2016', 'Qtn2017', 'Qtn2018'] : ['', 'Qtn2016', 'Qtn2017', 'Qtn2018'],
                                          items: const ['', 'Pending', 'Progress', 'Completed', 'Hold'],
                                          label: 'Status',
                                        ),
                                      ),
                                    ],
                                  ...
                                  Align(
                                    ...
                                    child: Container(
                                      ...
                                      if (checkoutBloc.projectFilterStream.value != '') {
                                        projectId = checkInFormModel?.data?[0].projectList?.firstWhere((e) => e.name == checkoutBloc.projectFilterStream.value).id;
                                      }

                                      String? checkOutStatusId;

                                      if (checkoutBloc.checkOutStatusFilterStream.value != '') {
                                        checkOutStatusId = outStatusId(status: checkoutBloc.checkOutStatusFilterStream.value);
                                      }
                                      ...
                                      if (checkoutBloc.checkOutFromDateFilterStream.value != '' &&
                                          checkoutBloc.checkOutToDateFilterStream.value != '' &&
                                          UtilityFunctions.isSecondDateBeforeFirst(
                                            firstDateStr: checkoutBloc.checkOutFromDateFilterStream.value,
                                            secondDateStr: checkoutBloc.checkOutToDateFilterStream.value,
                                          )) {
  ...
  String outStatusId({required String status}) {
    if (status == 'Pending') {
      return '1';
