                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Align(child: Text(widget.model.name, style: AppStyles.poppins.copyWith(fontSize: 18.w, color: Colors.purple[600], fontWeight: FontWeight.w800))),

                        Align(child: Text(widget.model.companyName, style: AppStyles.poppins.copyWith(fontSize: 14.w, color: Colors.grey[600], fontWeight: FontWeight.w800))),
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        const Spacer(),
                                        SelectableText(widget.model.phoneNumber, style: AppStyles.poppins.copyWith(fontSize: 11.w, color: Colors.grey[800], fontWeight: FontWeight.w800)),
                                      ],
                                    ),
                                  ),

                                  // _NewCardItem(field: 'Phone Number', value: model.phoneNumber, icondata: Icons.phone_outlined),
                                  _NewCardItem(field: 'Email', value: widget.model.email, icondata: Icons.email_outlined),
                                  _NewCardItem(field: 'Company Address', value: widget.model.companyAddress, icondata: Icons.note_alt_outlined),
                                  _NewCardItem(field: 'Company Landline', value: widget.model.companyLandline, icondata: Icons.lan_outlined),
                                  _NewCardItem(field: 'Company Location', value: widget.model.companyLocation, icondata: Icons.location_on_outlined),
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        const Spacer(),
                                        SelectableText(widget.model.companyWebsite, style: AppStyles.poppins.copyWith(fontSize: 11.w, color: Colors.grey[800], fontWeight: FontWeight.w800)),
                                      ],
                                    ),
                                  ),
                                ],
                              ...
                              child: Column(
                                children: [
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        const Spacer(),
                                        SelectableText(widget.model.createdBy, style: AppStyles.poppins.copyWith(fontSize: 11.w, color: Colors.grey[800], fontWeight: FontWeight.w800)),
                                      ],
                                    ),
                                  ),
                                  ...
                                  _NewCardItem(
                                    ...
                                    value: widget.model.contactSource,
                                    icondata: Icons.source_outlined,
                                  ),
                                  _NewCardItem(
                                    field: 'Contact Designation',
                                    value: widget.model.contactDesignation,
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        const Spacer(),
                                        SelectableText(widget.model.remarks, style: AppStyles.poppins.copyWith(fontSize: 11.w, color: Colors.grey[800], fontWeight: FontWeight.w800)),
                                      ],
                                    ),
                                  ),
                                ],
